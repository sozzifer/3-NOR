...
app.layout = html.Div([
    ...
    html.Div([
        html.Table([
            html.Tr([html.Th(id="header1", colSpan=2, style={"font-weight": "bold"})]),
            html.Tr([html.Td(["Mean"]), html.Td(id="mean1")]),
            html.Tr([html.Td(["Standard deviation"]), html.Td(id="std1")]),
            html.Tr([html.Td(["First quartile"]), html.Td(id="q1_1")]),
            html.Tr([html.Td(["Median"]), html.Td(id="median1")]),
            html.Tr([html.Td(["Third quartile"]), html.Td(id="q3_1")]),
            html.Tr([html.Td(["Interquartile range"]), html.Td(id="iqr1")]),
        ], style={
            'width': '48%', 'display': 'inline-block'}),
        html.Table([
            html.Tr([html.Th(id="header2", colSpan=2, style={"font-weight": "bold"})]),
            html.Tr([html.Td(["Mean"]), html.Td(id="mean2")]),
            html.Tr([html.Td(["Standard deviation"]), html.Td(id="std2")]),
            html.Tr([html.Td(["First quartile"]), html.Td(id="q1_2")]),
            html.Tr([html.Td(["Median"]), html.Td(id="median2")]),
            html.Tr([html.Td(["Third quartile"]), html.Td(id="q3_2")]),
            html.Tr([html.Td(["Interquartile range"]), html.Td(id="iqr2")]),
        ], style={
...
def update_histogram(value):
    ...
    fig1.update_traces(marker_line_width=1,
                       marker_line_color="white", marker_color="#d10373")
    ...
    fig2.update_traces(marker_line_width=1,
                       marker_line_color="white", marker_color="#9eab05")
...
def update_boxplot(value):
    ...
    fig1.update_traces(boxmean="sd", marker_color="#d10373")
    fig1.update_xaxes(
    ...
    fig2 = px.box(box_df2["Total happiness"],
                  range_x=[0, 28.5], orientation="h")
    fig2.update_traces(boxmean="sd", marker_color="#9eab05")
    fig2.update_xaxes(
